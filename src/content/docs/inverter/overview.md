...
description: The inverter converts the battery's DC into AC in the motor windings and controls the motor.
---
...
For the full design — specification, power calculations, DC-link capacitor sizing, the power stage and the proof of concept — see [Inverter — design](/inverter/design/).

:::note
Documentation on the control firmware will follow.
:::
